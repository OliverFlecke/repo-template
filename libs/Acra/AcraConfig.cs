...
public sealed record AcraConfig
{
	...
	/// <summary>Resource id of the "Entities Registered with ACRA" dataset, found via the
	/// Collections API: collection 1 ("Registered Entities with Unique Entity Number") lists this
	/// as one of its child datasets.</summary>
	...
	/// <summary>The datastore_search resource id for the ACRA dataset.</summary>

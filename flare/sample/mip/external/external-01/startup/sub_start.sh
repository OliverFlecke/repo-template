...
start_python() {
  python3 -u -m nvflare.private.fed.app.client.client_train -m "$WORKSPACE" -s fed_client.json --set secure_train=true uid=external org=maritime config_folder=config
}
